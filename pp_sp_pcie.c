...
#define PCI_SUBVENDOR_ID_SP_PP	(0x1a2)
#define PCI_SUBDEVICE_ID_SP_PP_IF0	(0x1)
#define PCI_SUBDEVICE_ID_SP_PP_IF1	(0x2)
#define PCI_SUBDEVICE_ID_SP_PP_CUST	(0xa00)
...
static const struct pci_device_id ids[] = {
	{PCI_DEVICE_SUB(PCI_VENDOR_ID_ALTERA, PCI_DEVICE_ID_STRATIXV,
		PCI_SUBVENDOR_ID_SP_PP, PCI_SUBDEVICE_ID_SP_PP_IF0)},
	{PCI_DEVICE_SUB(PCI_VENDOR_ID_ALTERA, PCI_DEVICE_ID_STRATIXV,
		PCI_SUBVENDOR_ID_SP_PP, PCI_SUBDEVICE_ID_SP_PP_IF1)},
	{PCI_DEVICE_SUB(PCI_VENDOR_ID_ALTERA, PCI_DEVICE_ID_STRATIXV,
		PCI_SUBVENDOR_ID_SP_PP, PCI_SUBDEVICE_ID_SP_PP_CUST)},
	{0},
};
